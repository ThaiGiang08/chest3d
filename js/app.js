...
function createPiece(color, piece, position) {
  ...
  if ( color === "w" ) { clone.classList.add("Trắng"); } 
  else { clone.classList.add("Đen"); }
...
function updateCaptured() {
  var wbPiece  = document.getElementById("board").getElementsByClassName("Trắng");
  var bbPiece  = document.getElementById("board").getElementsByClassName("Đen");
  var wjPiece  = document.getElementById("w-jail").getElementsByClassName("Đen");
  var bjPiece  = document.getElementById("b-jail").getElementsByClassName("Trắng");
...
function setTheme(event) {
  ...
  if (data === "classic" || data === "marble" ) { white = "Trắng", black = "Đen" }
